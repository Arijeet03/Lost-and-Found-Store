...
<!-- Modal -->
<div class="modal fade" id="Founditems" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Founded Items</h1>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="found" class="btn btn-primary">Save</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header"><H4>
                Found Items
                <a href="#" class="btn btn-primary float-right" data-toggle="modal" data-target="#Founditems">Add</a>
            </H4></div>
            <div class="card-body">
</div>
<div class="card-body">
